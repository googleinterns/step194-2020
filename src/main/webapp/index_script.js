        ...
        document.getElementById("videoContainer").innerHTML += 
            '<div id="video4" class="queueVideo">' +
              ...
              '<div id="video4Info" class="videoInfo"> ' +
                ...
                '<button class="removeVideoBtn" id="removeVideoBtn4" onclick="removeVideo(document.getElementById(\'video4\'))">' +
        ...
        document.getElementById("videoContainer").innerHTML += 
            '<div id="video5" class="queueVideo">' +
              ...
              '<div id="video5Info" class="videoInfo"> ' +
                ...
                '<button class="removeVideoBtn" id="removeVideoBtn5" onclick="removeVideo(document.getElementById(\'video5\'))">' +
                    '<img src="images/remove-from-queue.svg"/>' +
                '</button>' +
                '<p>3:49</p>' +
              '</div>' +
